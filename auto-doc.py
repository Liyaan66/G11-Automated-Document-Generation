...
#     tk.Label(root, text="Select Document to Generate", font=("Arial", 14)).pack(pady=10)

#     tk.Button(root, text="Generate Certificates", command=lambda: generate("certificates"), width=30).pack(pady=5)
#     tk.Button(root, text="Generate Transcripts", command=lambda: generate("transcripts"), width=30).pack(pady=5)
#     tk.Button(root, text="Generate Associate Documents", command=lambda: generate("associates"), width=30).pack(pady=5)
